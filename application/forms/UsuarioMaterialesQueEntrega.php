...
class Application_Form_UsuarioMaterialesQueEntrega extends Zend_Form
{
    ...
    public function init()
    {
		...
		$this->addElement(	'multiselect',
							'material',
							array(	'label' => 'Category\'s Material',
									'required' => false,
									'registerInArrayValidator' => false,
								));
        //lo cierro
		...
		$this->addDisplayGroup(
			...
			'fieldset1',
			array('legend' => 'User supplied materials'));	
