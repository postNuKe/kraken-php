...
class Kraken_CreateZipFile {
	...
	/**
	 * Crea el fichero zip con todo el contenido
	 * @param strng $zipName ruta hacia el ficher zip
	 */
	public function generateZipFile($zipName)
	{
		$fd=fopen($zipName, "wb");
